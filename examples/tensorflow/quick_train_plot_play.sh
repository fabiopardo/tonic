...
python3 -m tonic.train \
    ...
    --agent "tonic.tensorflow.agents.PPO(replay=tonic.replays.Segment(size=10, batch_size=2000, batch_iterations=30))" \
    ...
    --parallel 10 \
    --sequential 100 \
    --name "PPO-tensorflow-demo" \
    --seed 0

# Plot and reload.
python3 -m tonic.plot --path LunarLanderContinuous-v2 --baselines all &
python3 -m tonic.play --path LunarLanderContinuous-v2/PPO-tensorflow-demo/0 &
wait
